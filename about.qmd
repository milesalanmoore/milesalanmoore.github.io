...
::: {.about-aside}
![Miles on a foggy beach, Point Reyes, California.](assets/images/bio-photo-1.jpg){fig-alt="Miles Moore standing on a sandy beach in fog with rocks behind him."}
...
::: {.chip-row}
[Bayesian inference]{.chip} [State-space models]{.chip} [Survival analysis]{.chip} [Hidden Markov models]{.chip} [Remote sensing]{.chip} [HPC]{.chip} [R]{.chip} [Stan]{.chip} [Python]{.chip}
:::
